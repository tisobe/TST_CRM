...
$g15p2 = $sum[-10] unless ($g15p2);
$g13p2 = $sum[-11] unless ($g13p2);
$g15p5 = $sum[-8] unless ($g15p5);
$g13p5 = $sum[-9] unless ($g13p5);
$ostart = $sum[-7];
$fluence = $sum[-2];
$afluence = $sum[-1];
...
$txt .= sprintf "           External Proton Flux (p/cm^2-s-sr-MeV) : %.11e\n",$flux;
$txt .= sprintf "         Attenuated Proton Flux (p/cm^2-s-sr-MeV) : %.11e\n",$aflux;
$txt .= sprintf "  External Proton Orbital Fluence (p/cm^2-sr-MeV) : %.11e\n",$fluence;
$txt .= sprintf "Attenuated Proton Orbital Fluence (p/cm^2-sr-MeV) : %.11e\n",$afluence;
